...
# ⚠️⚠️⚠️ ОПАСНЫЙ СКРИПТ ⚠️⚠️⚠️
# 
# Этот скрипт удаляет:
# - ВСЕ загруженные файлы из /home/urch/Music/Yandex
# - ВСЕ логи
# - ВСЕ таблицы базы данных (download_queue, playlist_sync, settings)
# - Даже скрипты (*.sh) в корне проекта
#
# ИСПОЛЬЗУЙТЕ С ОСТОРОЖНОСТЬЮ!
# Скрипт полной очистки проекта Yandex Music Downloader

echo "⚠️⚠️⚠️ ОПАСНЫЙ СКРИПТ ⚠️⚠️⚠️"
echo "Этот скрипт удалит ВСЕ данные!"
echo ""
